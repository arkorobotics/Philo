...
fuel = {'Air':Fuel("Compressed Dry Air", 1.005, 0.718, 28.97), \
	'CO2':Fuel("Carbon Dioxide", 0.846, 0.657, 44.01)}
...
# Flight Sim
# ----------------------------------------
print "Initial Fuel Mass (kg): "
print fuel_mass

print "Initial Vehicle Wet Mass (kg): "
print veh_mass

print "Exhaust Mass Flow (kg/s): "
print mass_flow
