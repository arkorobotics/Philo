...
def load_config(cfgfile):
	...
	tankdat = cfgdat["tank"]
	tankobj = Tank(tankdat["volume"], tankdat["pressure"], tankdat["tank_mass"], tankdat["reg_min"], tankdat["reg_max"], tankdat["reg_out"], tankdat["temp"])
	
	# Initialize a Propellant Object
	propellantdat = cfgdat["propellant"]
	propellantobj = Propellant(propellantdat["propellant_type"], propellantdat["cp"], propellantdat["cv"], propellantdat["molar_mass"])

	# Initialize a Regulator Object
	regulatordat = cfgdat["regulator"]
	regulatorobj = Regulator(regulatordat["in_min"],regulatordat["in_max"],regulatordat["out_min"],regulatordat["out_max"],regulatordat["reg_in"],regulatordat["reg_out"])
	...
	vehicleobj = Vehicle(cfgdat["avionics_mass"], cfgdat["mech_mass"], tankobj, propellantobj, regulatorobj, heaterobj, engineobj)
